...
#define Z_HOME_BUMP_MM Z_CLEARANCE_BETWEEN_PROBES
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 10*60, 3*60 }  // Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "G28XY R5"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
