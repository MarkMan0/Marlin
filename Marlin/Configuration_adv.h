...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_IS_EXTRUDER_1_FAN  //use the controller fan to cool the extruder
#endif
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 4*60, 3*60 }  // Feedrates for manual moves along X, Y, Z, E from panel
...
#define LCD_SET_PROGRESS_MANUALLY
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         P1_26 // Pin to detect power loss (Y_MAX_PIN)
 ...
 */
#define MINIMUM_STEPPER_DIR_DELAY 40
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define Z_MICROSTEPS   16   //reduce resolution for torque
